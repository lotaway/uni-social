module.exports = {
	...
	testEnvironmentOptions: {
		...
		"app": { // 需要安装 HBuilderX
			android: {
				appid: "__UNI__1C513A6", //自定义基座测试需配置manifest.json中的appid
				package: "com.uni.social", //自定义基座测试需配置Android包名
	...
	rootDir: __dirname,
	testMatch: ['**/__tests__/**/(*.)?test.[jt]s?(x)'], // 测试文件目录
